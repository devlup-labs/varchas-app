...
class _LeaderBoardScreenState extends State<LeaderBoardScreen> {
 // bool isFabVisible = true;  // for floating button visibility
  ...
  List<Widget> leaderBoardWidgets = [Column(
  ...
  List<Widget> rankListWidgets(rankList, pageSize){
    return List.generate(rankList.length, (index) {
      return LeaderBoardTeamCard(rank: (index+1).toString(), teamName: rankList[index]['college'], score: rankList[index]['score'].toString(), size: pageSize);
    });
  }
}
